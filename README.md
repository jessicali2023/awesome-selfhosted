...
- [Twenty](https://twenty.com) - A modern CRM offering the flexibility of open source, advanced features, and a sleek design. ([Demo](app.twenty.com), [Source Code](https://github.com/twentyhq/twenty)) `AGPLv3` `TypeScript`
